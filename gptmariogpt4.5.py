...
class Game:
    ...
    def draw_bs_menu(self):
        ...
        pygame.draw.rect(screen, (64, 0, 128), (250, 150, 300, 80))
        pygame.draw.rect(screen, WHITE, (250, 150, 300, 80), 3)
        ...
        for i, item in enumerate(menu_items):
            ...
            if i == self.bs_menu_selection:
                pygame.draw.polygon(screen, COIN_YELLOW, 
        ...
        while running:
            ...
            if self.state == GameState.BS_MENU:
                ...
                for i in range(3):
                    ...
                    pygame.draw.ellipse(screen, WHITE, (x + 20, y - 10, 60, 40))
                    pygame.draw.ellipse(screen, WHITE, (x + 40, y, 60, 40))
                    
                # Hills background
                pygame.draw.ellipse(screen, (34, 139, 34), (50, 400, 200, 300))
                pygame.draw.ellipse(screen, (34, 139, 34), (500, 420, 250, 280))
                
                mario_y = math.sin(self.mario_sprite_animation * 0.15) * 5
                self.overworld.draw(self.screen, 0, mario_y)
                
                # Instructions
                inst = self.small_font.render("Press 1-3 for levels, B for Boss, Arrow keys to select world", True, WHITE)
                self.screen.blit(inst, (100, 550))
                ...
                continue_text = self.small_font.render("Press ENTER to restart", True, WHITE)
                ...
                continue_text = self.small_font.render("Press ENTER to return to menu", True, WHITE)
